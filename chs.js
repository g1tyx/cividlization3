...
var cnItems = {
    ...
    'Bountiful Cove': '丰饶海湾',
    'Characteristics': '特性',
    'Cividlization 3 version 0.1.0 (early prototype': '《文明3》0.1.0版本 (早期原型',
    'Export / Import': '导出 / 导入',
    'lvl': '等级',
    'Ned': '内德',
    'No research': '无研究',
    'O': 'O',
    'Save (': '保存 (',
    'This is your science production. It is useful to unlock new features.': '这是你的科学生产。这对解锁新功能很有用。',
    ' is very important, it is required for your city to expand into new areas.': '是非常重要的，这是需要你的城市扩展到新的领域。',
    'All citizens produce a very small amount of science and culture.': '所有公民都贡献了非常少的科学和文化。',
    'And don\'t forget to start a research to unlock useful features !': '不要忘记开始研究解锁有用的功能！',
    'Area bonus only applies to corresponding ': '区域加成只适用于对应的',
    'Areas might have a bonus like this one which boosts farming.': '一些地区可能会有像这样的奖励来促进农业发展。',
    'buildings once you unlock them.': '一旦你打开建筑。',
    'Citizens get experience when working on a specific activity. They get more productive when they level up.': '市民在从事特定活动时获得经验。当他们升级时，他们会变得更有效率。',
    'eg. farming bonus only applies to farms': '如。农场加成只适用于农场',
    'farming': '农业',
    'favorite activity in which they get experience faster.': '最喜欢的活动，他们可以更快地获得经验。',
    'For this, just drag and drop him into the farming section.': '为此，只需将其拖放到农业部分。',
    'Happy citizens are more productive while unhappy citizens will be less efficient.': '快乐的公民生产力更高，而不快乐的公民效率更低。',
    'Idle citizens produce a very small amount of food as well.': '无所事事的市民生产的食物也非常少。',
    'If happiness gets very low, citizens might leave your city.': '如果幸福指数很低，市民可能会离开你的城市。',
    'Ned will not be very productive at first but don\'t worry, he will improve !': '内德一开始不会很有效率，但别担心，他会进步的！',
    'No ': '无',
    'Now you\'re ready to start.': '现在你可以开始了。',
    'People will stop working if they are not fed properly.': '如果人们吃不饱，他们就会停止工作。',
    'Right now you are limited to a population of 2.': '现在你的数量被限制在2个。',
    'Right now, your happiness is at its max value: 100 which gives you a nice +75% bonus on every production': '现在，你的快乐处于最大值：100，这让你在每次生产中获得+75%的奖励',
    'Save ': '保存',
    'They also have a': '他们也有',
    'This is your citizens happiness. It has a value between 0 and 100.': '这是你们国民的幸福。它的值在0到100之间。',
    'This is your culture.': '这就是你的文化。',
    'This is your first area.': '这是你的第一个区域。',
    'This is your first citizen. As you can see he is idle at this time.': '这是你们的第一个公民。如你所见，他此时正闲着。',
    'This is your food. Produce food to increase your population.': '这是你的食物。生产粮食来增加人口。',
    'This is your population.': '这是你们的人口。',
    'to increase your population': '增加你的人口',
    'You can\'t use it right now but it will be used to assign': '你现在不能用它，但它会被用来分配',
    'You should assign Ned to': '你应该把内德分配给',
    'You will be able to get more info in game by pointing on those numbers.': '通过指向这些数字，你可以在游戏中获得更多信息。',
    'You will be able to increase this limit later on.': '稍后您可以增加这个限制。',
    "Import": "导入",
    "Already discovered": "已发现",
    "Dwellings": "住宅",
    "production increased. Unlock": "产量增加。解锁",
    "Require": "要求 ",
    " is needed to get new": " 需要获得新的",
    "areas": "区域",
    "City size": "城市大小",
    "Feeding population": "供养人口",
    "Food is required to get more citizens": "需要食物来吸引更多的市民",
    "Happiness effect": "幸福度效果",
    "Idle citizens": "空闲市民",
    "Max population": "人口上限",
    "Population ": "人口 ",
    "Build": "建造",
    ...
    "level": "等级",
    "population": "人口",
    "All xp will be lost upon change !": "更改后将失去所有经验值！",
    " tech": "科技",
    "Events": "事件",
    "Max": "最大",
    "productivity": "生产力",
    ...
    "Calendar !": "日历 !",
    "Crop Rotation !": "轮作 !",
    "Fathomless Marsh !": "深不可测的沼泽 !",
    "Entertaining Valley !": "有趣的山谷 !",
    "Drama !": "戏剧 !",
    "Masonry !": "砖石建筑 !",
    "Craftsmanship !": "工艺 !",
    "efficiency": "效率",
    ...
    "production increased": "生产增加",
    "Creating +": "创建 +",
    "Entertaining +": "娱乐 +",
    "Fighting +": "战斗 +",
    "Searching +": "搜索 +",
    "Unselect": "取消选择",
    "Splendid Valley": "灿烂的山谷",
    "Objective": "目标",
    "Marauder camp": "掠夺者营地",
    "Launch": "启动",
    "Interesting Pond": "有趣的池塘",
    "Interesting Bay": "有趣的海湾",
    "Harsh Hill": "崎岖的山",
    "Fathomless Marsh": "深不可测的沼泽",
    "Fathomless Hill": "深不可测的山",
    "Expedition": "远征",
    "Entertaining Valley": "有趣的山谷",
    ". Double dwellings capacity.": "。住房容量翻倍。",
    "Coliseum": "竞技场",
    "Power": "力量",
    "Tragedy": "悲剧",
    " bonus is now applied to expedition speed": "加成现在适用于远征速度",
    " level": " 等级",
    "Equipped": "已装备",
    "Relic": "圣遗物",
    "Expeditions have a chance to gain gold and artefacts": "远征有概率获得金币和神器",
    " better sell prices": "更好的售价",
    "Allow usage of": "允许使用",
    "artefacts": "神器",
    "Higher levels allow more artefacts": "更高的级别允许更多的神器",
    "UNIQUE": "独特",
    "Power available for expeditions": "为探险提供动力",
    "Builders produce buildings xp which allow them to level up and be more efficient": "建造者所创造的建筑经验值能够帮助他们升级并提高效率",
    "Gold available for improving": "可用于提升的金币",
    " area": " 区域",
    " Tactics": " 战术",
    "No tech available": "暂无可用科技",
    "Impenetrable Valley": "坚不可摧的山谷",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnPrefix = {
    ...
    'Activity: ': '活动: ',
    'Area Bonus: ': '区域加成: ',
    "Our scholars have discovered a new technology: ": "我们的学者发现了一项新技术：",
    'The city has expanded into a new area: ': '这个城市已经扩展成一个新的地区：',
    'Travel time: ': '旅行时长: ',
    '': '',
    '': '',
    '': '',
...
var cnRegReplace = new Map([
    ...
    [/^ Tactics ([\d\.,]+)m$/, ' 战术 $1 分钟'],
    [/^ Tactics ([\d\.,]+)h$/, ' 战术 $1 小时'],
    [/^Craftsmanship ([\d\.,]+)m$/, '工艺 $1 分钟'],
    [/^Politics ([\d\.,]+)h$/, '政治 $1 小时'],
    [/^Gunpowder (.+)$/, '火药 $1'],
    [/^ citizen in (.+)$/, '市民在 $1'],
